...
/* positAdd */
#define CSR_POSITADD_BASE (CSR_BASE + 0x1000L)
#define CSR_POSITADD_N1_ADDR (CSR_BASE + 0x1000L)
#define CSR_POSITADD_N1_SIZE 1
static inline uint32_t positAdd_n1_read(void) {
	return csr_read_simple((CSR_BASE + 0x1000L));
}
static inline void positAdd_n1_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1000L));
}
#define CSR_POSITADD_N2_ADDR (CSR_BASE + 0x1004L)
#define CSR_POSITADD_N2_SIZE 1
static inline uint32_t positAdd_n2_read(void) {
	return csr_read_simple((CSR_BASE + 0x1004L));
}
static inline void positAdd_n2_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1004L));
}
#define CSR_POSITADD_SUB_ADDR (CSR_BASE + 0x1008L)
#define CSR_POSITADD_SUB_SIZE 1
static inline uint32_t positAdd_sub_read(void) {
	return csr_read_simple((CSR_BASE + 0x1008L));
}
static inline void positAdd_sub_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1008L));
}
#define CSR_POSITADD_ISZERO_ADDR (CSR_BASE + 0x100cL)
#define CSR_POSITADD_ISZERO_SIZE 1
static inline uint32_t positAdd_isZero_read(void) {
	return csr_read_simple((CSR_BASE + 0x100cL));
}
#define CSR_POSITADD_ISNAR_ADDR (CSR_BASE + 0x1010L)
#define CSR_POSITADD_ISNAR_SIZE 1
static inline uint32_t positAdd_isNaR_read(void) {
	return csr_read_simple((CSR_BASE + 0x1010L));
}

/* sim_finish */
#define CSR_SIM_FINISH_BASE (CSR_BASE + 0x1800L)
#define CSR_SIM_FINISH_FINISH_ADDR (CSR_BASE + 0x1800L)
#define CSR_SIM_FINISH_FINISH_SIZE 1
static inline uint32_t sim_finish_finish_read(void) {
	return csr_read_simple((CSR_BASE + 0x1800L));
}
static inline void sim_finish_finish_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1800L));
}

/* sim_marker */
#define CSR_SIM_MARKER_BASE (CSR_BASE + 0x2000L)
#define CSR_SIM_MARKER_MARKER_ADDR (CSR_BASE + 0x2000L)
#define CSR_SIM_MARKER_MARKER_SIZE 1
static inline uint32_t sim_marker_marker_read(void) {
	return csr_read_simple((CSR_BASE + 0x2000L));
}
static inline void sim_marker_marker_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2000L));
}

/* sim_trace */
#define CSR_SIM_TRACE_BASE (CSR_BASE + 0x2800L)
#define CSR_SIM_TRACE_ENABLE_ADDR (CSR_BASE + 0x2800L)
#define CSR_SIM_TRACE_ENABLE_SIZE 1
static inline uint32_t sim_trace_enable_read(void) {
	return csr_read_simple((CSR_BASE + 0x2800L));
}
static inline void sim_trace_enable_write(uint32_t v) {
